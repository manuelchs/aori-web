    ...
    <section class="desfase-navbar hero-portafolio jk">
        <div class="info-project">
            <div class="logo-icons">
                <img class="project-logo" src="#/img/portafolio/jk-logo.png" alt="">
    ...
    <section class="project">
        <div class="main-wrapper">
            <div class="project-stage">
                ...
                <div class="stage-img">
                    <img class="lightbox-item bg" src="#/img/portafolio/jk/jk-1.png" alt="">
                </div>
            ...
            <div class="project-stage">
                ...
                <div class="stage-img">
                    <img class="lightbox-item" src="#/img/portafolio/jk/jk-2.png" alt="">
                </div>
                <div class="stage-desc">
