...
<body>
    ...
    <section class="desfase-navbar hero-services hero-clips">
        ...
        <div class="main-wrapper">
            ...
            <img class="service-icon" src="#/img/services/clips/clips-icon.png" alt="Icono de clips promocionales e institucionales de AORI Brand Media Consulting en Guadalajara">
        </div>
    </section>
            ...
            <div class="main-wrapper-services-sec-large">
                <div class="slider-services-sec-wrapper">
                    <div id="left-button" class="slider-services-sec-button left-button">
                        <img src="#/img/arrow-left.png" alt="AORI Brand Media Consulting">
                    </div>
                    <div id="right-button" class="slider-services-sec-button right-button">
                        <img src="#/img/arrow-right.png" alt="AORI Brand Media Consulting">
                    </div>
                    <div id="sliderServices" class="slider-services-sec">
                        <div class="slider-services-sec-item sm1">
                            <img class="lightbox-item bg" src="#/img/services/clips/clips-example-1.png" alt="Ejemplo fotografía de producto por AORI Brand Media Consulting">
                            <p class="slider-desc">Fotografía de Producto</p>
                            <p class="brand-info">HB HANDBAGS</p>
                        </div>
                        <div class="slider-services-sec-item sm2">
                            <img class="lightbox-item" src="#/img/services/clips/clips-example-2.png" alt="Composición y montaje fotográfico por AORI Brand Media Consulting">
                        ...
                        <div class="slider-services-sec-item sm4">
                            <img class="lightbox-item video" src="#/img/services/clips/clips-example-4.png" youtube="gKSeOn6C8iY" alt="Video institucional de GIT por Aori Brand Media Consulting">
